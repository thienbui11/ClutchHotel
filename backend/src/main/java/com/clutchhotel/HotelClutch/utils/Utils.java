package com.clutchhotel.HotelClutch.utils;
...
public class Utils {
    ...
    public static UserDTO mapUserEntityToUserDTOPlusUserBookingsAndRoom(User user) {
        ...
        if (!user.getBooking().isEmpty()) {
            userDTO.setBookings(user.getBooking().stream().map(booking -> mapBookingEntityToBookingDTOPlusBookedRooms(booking, false)).collect(Collectors.toList()));
        }
        return userDTO;
    }
