...
import com.clutchhotel.HotelClutch.repo.BookingRepository;
import com.clutchhotel.HotelClutch.repo.RoomRepository;
    ...
    public Response saveBooking(Long roomId, Long userId, Booking bookingRequest) {
        ...
        try {
            ...
            if(!roomIsAvailable(bookingRequest, existingBookings)) {
                throw new OurException("Room Not Available");
            }
